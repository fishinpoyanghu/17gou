...
return array(
		...
		'base' => array(
				'db_cfg_name' => 'admin',
				'db_tbl_alias' => 'app_loading',
				'pkid' => 'app_loading_id',
				'autoidCode' => C('AUTOID_APPLOADING'),
				'title' => '启动设置',
				'where' => array(
						'type' => 0,
						'stat' => 0,
		...
		'list' => array(
				// 第一个字段必须是主键
				'app_loading_id' => array(
						'name' => 'ID',
				),
				'img' => array(
						'name' => '图片',
						'format' => 'tf_apploading_showpic|54'
				),
				'url' => array(
						'name' => '链接'
				),
		...
		'add' => array(
				'addBtnName' => '添加启动图片 <i class="icon-plus"></i>',
				'addTitle' => '添加启动图片',
				...
				'inputGroups' => array(
						'img' => array(
								...
								'attr' => array(
										...
										'iconLib' => '',
										'fontLib' => '',
										'tipsnew' => '建议上传640*1136的PNG图片，大小<1MB',
								),
						),
						'url' => array(
								'name' => '链接',
								'placeholder' => 'http://',
								'type' => 'text',
								'tips' => '跳转链接，留空表示无链接', // 提示文字，就text和password支持
						),
						'weight' => array(
								'name' => '权重',
								'tips' => '整数,值越大越靠前',
