...
return array(
		...
		'base' => array(
				...
				'db_tbl_alias' => 'reply',
				'pkid' => 'reply_id',
				'autoidCode' => C('AUTOID_REPLY'),
				'title' => '评论列表',
				'where' => array(
						'target_type' => 2,
						'is_del' => 0,
				),
				'orderby' => 'ORDER BY reply_id DESC',
				'pagesize' => 13, // 列表的分页数目
				...
				// [高级功能] 之 搜索功能 start
				'search' => array(		
						'searchKey'   => 'content', // 定义admin表需要被搜索的字段
						'searchSql'   => '%{$kw}%', // 不加%表示精确匹配，哪边加引号就表示在哪边做模糊检索。
						'searchBtn'   => '搜索', // 搜索按钮的名字
						'palceholder' => '按回复内容搜索', // 输入框的palceholder属性
