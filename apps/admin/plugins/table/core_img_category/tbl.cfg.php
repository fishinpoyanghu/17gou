...
return array(
		...
		'base' => array(
				...
				'autoidCode' => C('AUTOID_IMG_CATEGORY'),
				'title' => '图片分类管理',
				'where' => array(
						'dt' => 0,
				),
				'orderby' => 'ORDER BY img_category_id DESC',
				'pagesize' => 10, // 列表的分页数目
				...
				'search' => array(
						...
						'palceholder' => '按分类名搜索', // 输入框的palceholder属性
		...
		'add' => array(
				...
				'inputGroups' => array(
						'name' => array(
								...
								'validate' => array(
										'tpv_notnull||分类名不能为空',
										'tpv_length|1,10||分类名长度必须在1-10之间',
								),
						),
				),
				'submitBtn' => array(
