...
return array(
		...
		'base' => array(
				...
				'search' => array(			
						...
						'palceholder' => '按左侧目录名搜索', // 输入框的palceholder属性
		...
		'add' => array(
				...
				'inputGroups' => array(
						...
						'icocss' => array(
								'name' => '图标',
								'placeholder' => '输入awesome样式名',
								'tips' => '支持Font Awesome字体图标',
								'type' => 'text',
								'require' => false,
								'validate' => array(
										'tpv_length|0,20||图标CSS类名长度不能超过20字符',
								),
						),
						'weight' => array(
								'name' => '权重',
		...
		'delete' => array(
				...
				'del_key' => 'stat',
				'del_value' => 1,
				'confirmMsg' => '确定要删除此左侧目录？',
				'confirmMsgMulti' => '确定要批量删除左侧目录？',
				'defaultSet' => array(
						'ut'  => 'time', // 调用time()函数
				),
		),
