 ...
 * @return string
 */
function tf_pic_app_nav_showpic($var, $w, $h) {

	return '<a href="'.C('UPLOAD_DOMAIN').'app_nav/'.$var.'" target="_blank"><img src="'.C('UPLOAD_DOMAIN').'app_nav/'.$var.'" width="'.$w.'" height="'.$h.'"></a>';
}
