            ...
            <div class="main-container">
                    ...
                    <div class="right-item vercenter-wrap">
                        <span class="dp-search-item item vercenter">
                            <div class="input-group dp-input" style="float:left;">
                                <input class="form-control input-sm" name="keyword" data-type="search" type="text" placeholder="按收件人搜索" value="<?php echo $data['keyword']?>" />
                                <span class="input-group-btn">
                                    <button class="btn btn-sm btn-default" id="search"><i class="icon-search"></i></button>
                                </span>
                            </div>
                            <a href="?c=activity&a=editMsg" class="btn-orange btn" style="margin-left:5px;">+发送消息</a>
                        </span>
                    </div>
                </div>
                <div class="table-wrap">
                    <table class="table-condensed dp-table table table-striped" id="dp-list-tbl">
                        <thead>
                        <tr>
                            <th class="dp-col-align-left"><input class="dp-checkbox" id="checkAll" style="margin:0 15px 0 5px;" type="checkbox" />内容</th>
                            <th>收件人</th>
                            <th>发送时间</th>
                            <th>操作</th>
                        </tr>
                        ...
                        <tbody>
                            <?php foreach($data['list'] as $val){?>
                                <tr>
                                    <td>
                                        <div class="fl">
                                            <input name="multi_delete" class="dp-checkbox" type="checkbox" value="<?php echo $val['msg_notify_id'];?>" />
                                        </div>
                                    ...
                                    <td>
                                        <a href="?c=activity&a=editMsg&id=<?php echo $val['msg_notify_id']?>" >编辑</a> |
                                        <a data-id="<?php echo $val['msg_notify_id']?>" class="js-del">删除</a>
                                    </td>
                                </tr>
                            <?php }?>
                        </tbody>
