                ...
                <div class="dp-page-head">
                    ...
                    <div class="right-item vercenter-wrap">
                        ...
                        <span class="dp-search-item item vercenter">
                            ...
                            <a href="?c=goods&a=addGoodsCfy" class="btn-orange btn" id="table_add_btn" style="margin-left:5px;">+添加分类</a>
                        </span>
                    </div>
                </div>
                        ...
                        <tbody>
                            <?php foreach($data['list'] as $val){?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="?c=goods&a=addGoodsCfy&id=<?php echo $val['goods_type_id']?>" style="margin-right:3px;"><i class="icon-pencil gray-dark" title="编辑"></i></a>
