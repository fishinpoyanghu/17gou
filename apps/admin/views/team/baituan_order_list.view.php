                ...
                <div class="dp-page-head">
                    <div class="dp-nav">
                        <ul class="dp-nav-inner">
                            <li>
                                <a href="?c=team&a=baituan_order" <?php if($data['state'] == 0)echo 'class="current"'?>>全部订单</a>
                            </li>
                            <li>
                                <a href="?c=team&a=baituan_order&state=1" <?php if($data['state'] == 1)echo 'class="current"'?>>待发货</a>
                            </li>
                            <li>
                                <a href="?c=team&a=baituan_order&state=2" <?php if($data['state'] == 2)echo 'class="current"'?>>待收货</a>
                            </li>
                        </ul>
                    </div>
                </div>
