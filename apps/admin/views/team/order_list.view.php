                ...
                <div class="dp-page-head">
                    <div class="dp-nav">
                        <ul class="dp-nav-inner">
                            <li>
                                <a href="?c=team&a=order" <?php if($data['state'] == 0)echo 'class="current"'?>>全部订单</a>
                            </li>
                            <li>
                                <a href="?c=team&a=order&state=1" <?php if($data['state'] == 1)echo 'class="current"'?>>待发货</a>
                            </li>
                            <li>
                                <a href="?c=team&a=order&state=2" <?php if($data['state'] == 2)echo 'class="current"'?>>待收货</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <tbody>
                            <?php foreach($data['list'] as $val){?>
                                <tr><td><?php echo $val['logistics_num']?></td>
                                    ...
                                    <td class='get-name'><?php echo $val['name']?></td>
                                    <td class='get-phone'><?php echo $val['phone']?></td>
                                    <td class='get-add'><?php echo $val['add'];?></td>
                                    <td><?php echo date('Y-m-d H:i:s',$val['t']);?></td>
                                    <td><?php echo $val['state'];?></td>
                                    <td>
                                        <?php if($val['address'] !=='-' && $val['logistics_stat'] == 0 && $val['logistics_id']){?>
                                        <a data-id="<?php echo $val['logistics_id']?>" data-ordernum="<?php echo $val['order_num']?>" class="js-entering" data-toggle="modal" data-target="#express">录入物流信息</a>
                                        <?php }else{echo '-';}?>
                                    </td>
                                </tr>
                            <?php }?>
                ...
                <div class="form-horizontal">
                    <div class="tab-content">
                        ...
                        <div class="form-group" style="margin: 20px 0 30px;">
                         ...
                         <div class="form-group" style="margin: 20px 0 30px;">
                            <label class="control-label js-text">收件人</label>
                            <div class="control-cont">
                                <span class="dm-input dib">
                                    <input name="nick" type="text" class="form-control ipt-width-mid" />
                                </span>
                            </div>
                        </div>
                           <div class="form-group" style="margin: 20px 0 30px;">
                            <label class="control-label js-text">手机号</label>
                            <div class="control-cont">
                                <span class="dm-input dib">
                                    <input name="phone" type="text" class="form-control ipt-width-mid" />
                                </span>
                            </div>
                        </div>
                           <div class="form-group" style="margin: 20px 0 30px;">
                            <label class="control-label js-text">收货地址</label>
                            <div class="control-cont">
                                <span class="dm-input dib"> 
                                    <input name="addr" type="text" class="form-control ipt-width-mid" />
                                </span>
                            </div>
                        </div>
