...
//      end 活动页面
        ...
        .state('pintuan_main_page', {
          ...
          .state('pintuan_main_page2', {
              url: '/pintuan_main_page2',
              templateUrl: function() {return 'webApp/html/pintuan_main_page/pintuan_main_page2.html'},
              controller: 'Pintuan_MainpageController',
              controllerUrl: 'html/pintuan_main_page/js/controller_pintuan_main_page2',
              dependencies: [
