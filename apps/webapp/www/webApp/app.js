...
define(['angular',
    'uiRouter',
    'ionicAngular','angularMessages','angular-async-loader'],

  function (angular, uiRouter,ionicAngular,angularMessages,asyncLoader) {
    'use strict';
    var app = angular.module('app', [
      ...
      app.provider('$cordovaInAppBrowser', [function () {
