...
define(
	...
	function(app) {
		app.directive('viewBuyFooter', viewBuyFooter);
		viewBuyFooter.$inject = ['trolleyInfo', 'GoodsModel', 'MyUrl', 'ToastUtils', '$state', '$ionicPopup']

		function viewBuyFooter(trolleyInfo, GoodsModel, MyUrl, ToastUtils, $state, $ionicPopup) {

			return {
				restrict: 'E',
				templateUrl: 'webApp/components/view-buy-footer/view_buy_footer.html',
				scope: {
					activity: "="
				},
