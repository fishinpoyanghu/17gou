...
define(
  ...
  function (app) {
  app.controller('baituanCountDetailCtrl', baituanCountDetailCtrl);

  baituanCountDetailCtrl.$inject = ['$scope', '$stateParams', 'GoodsModel','PintuanModel', 'ToastUtils']
  function baituanCountDetailCtrl($scope, $stateParams, GoodsModel,PintuanModel, ToastUtils) {
    ...
    function refresh() {
      PintuanModel.baituan_getCountDetail_info($scope.activityId,
...
//      PintuanModel.baituan_getDetail_info($scope.activityId, function onSuccess(response, data) {
//              if(data.code==0) {
