...
define(
  ...
  function (app) {
  app.controller('baituanPublishCtrl',baituanPublishCtrl);
  baituanPublishCtrl.$inject = ['$scope','$state','$timeout','GoodsModel','PintuanModel','$timeout'];
  function baituanPublishCtrl($scope,$state,$timeout,GoodsModel,PintuanModel,$timeout) {
