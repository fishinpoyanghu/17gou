...
define(
  ...
  function(app){
    'use strict';
    app
      .controller('tenYuanController',['$scope','$stateParams','$timeout','ToastUtils','ClassificationService', function($scope,$stateParams,$timeout,ToastUtils,ClassificationService){
        function initial(){
