...
define(
    ...
    function(app,funParabola){
        'use strict';
        app
            .controller('ten_yuan_areaController',['$scope','$stateParams','$timeout','ToastUtils','ClassificationService', 'ActivityModel','trolleyInfo','$window','Global','$ionicScrollDelegate','$state','$ionicPopup',
