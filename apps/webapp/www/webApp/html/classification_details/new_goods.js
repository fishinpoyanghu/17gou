...
define(
    ...
    function(app,funParabola){
        'use strict';
        app
            .controller('new_goodsController',['$scope','$stateParams','$timeout','ToastUtils','ClassificationService', 'ActivityModel','trolleyInfo','$window','Global','$ionicScrollDelegate','$state','$ionicPopup','$ionicGesture','Storage',
