...
define(
    ...
    function(app,funParabola){
        'use strict';
        app
            .controller('return_cashController',['$scope','$stateParams','$timeout','ToastUtils','ClassificationService', 'ActivityModel','trolleyInfo','$window','Global','$ionicScrollDelegate','$state','$ionicPopup','$ionicGesture','Storage',
