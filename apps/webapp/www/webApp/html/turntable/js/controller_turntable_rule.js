...
define([
    ...
    app.controller(
        'turntableRuleCtrl', ['$scope', '$ionicHistory', '$location', '$state', '$stateParams', '$timeout', 'ToastUtils', 'Storage','$http','$sce',
            function($scope, $ionicHistory, $location, $state, $stateParams, $timeout, ToastUtils, Storage,$http,$sce) {
                ...
                $http.get(url + 'uploads/other/lottery.html?t='+ (+new Date())).then(function(re) {
