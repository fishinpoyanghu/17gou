	...
	**/
	...
	public function MakeSign($key='')
	{
        ...
        if($key){
            ...
            if($this->values['attach']=='app'){
                $k = WxPayConfig::APPKEY;
            }else{
                $k = WxPayConfig::KEY;
            }
        }
 ...
 *
 */
class WxPayAppUnifiedOrder extends  WxPayDataBase
{
    /**
     * 设置微信分配的公众账号ID
     * @param string $value
