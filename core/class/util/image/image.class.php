...
class Image {
     ...
     * @param boolean $enlarge 是否允许放大图片 默认是允许
     +----------------------------------------------------------
     * @return void
     +----------------------------------------------------------
     * @throws SimpleException
     +----------------------------------------------------------
     */
    static function thumb($image, $type='', $filename='', $maxWidth=200, $maxHeight=50, $interlace=true, $enlarge=true) {
        ...
        if($info !== false) {
            ...
            //ImageString($thumbImg,2,5,5,"SimplePHP",$gray);
            // 生成图片
     ...
     * @throws SimpleException
     +----------------------------------------------------------
     */
    static function cut($image, $type='', $filename='', $x=0, $y=0, $w=20, $h=20, $interlace=true) {
