    ...
    function(avalon, $, httpFactory,countdowm) {
        ...
        function makeOrder (goodsData) {
            ...
            var orderData = [{
                    ...
                    num:goodsData.activity_type==2?viewModel.join_number*10:viewModel.join_number
                }]
...
//                  viewModel.goodsData.last=[viewModel.goodsData.last,viewModel.goodsData.last,viewModel.goodsData.last,viewModel.goodsData.last]
//              	viewModel.goodsData.lastMore=[viewModel.goodsData.last,viewModel.goodsData.last,viewModel.goodsData.last,viewModel.goodsData.last]
//              	console.log(viewModel.goodsData.lastMore);
                	console.log(viewModel.goodsData)
//              	console.log(viewModel.goodsData.lastMore)
